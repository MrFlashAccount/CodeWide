...
| `src/ui/VoiceAura.native.tsx`, `VoiceAura.web.tsx`                                                 | `src/presentation/voice/VoiceAuraView.tsx`                                                  | Existing files retain native level/application-overlay adaptation; `keep_temporarily`.                        |
