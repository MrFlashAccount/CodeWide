...
| Conversation: attachCodeReview, attachContentReview, contentReviewAttachmentIds, clearContentReviewAttachmentId | `features/review/comments/reviewSubmission.ts prepares content; features/composer/attachments/reviewAdmission.ts owns draft attachment ID admission/acknowledgement` |
...
| `rendering/CodeReviewWorkspace` | `features/review/workspace/CodeReviewWorkspace` | `CodeWideScreen.tsx` |
| `rendering/code-review-files` | `features/review/resources/reviewFiles` | `CodeWideScreen.tsx`, `rendering/CodeReviewWorkspace.tsx` |
