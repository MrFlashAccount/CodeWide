//! Durable ownership and resource limits for authenticated workspace uploads.
...
use super::owner::UploadOwnerKey;

// Historical on-disk table name is retained so existing V1 resumable uploads keep their ownership.
...
fn owner_for_device(device_id: &str) -> Option<UploadOwnerKey> {
    UploadOwnerKey::derive(&AuthorizationContext::Session {
...
mod tests {
    ...
    fn owner(device_id: &str) -> UploadOwnerKey {
