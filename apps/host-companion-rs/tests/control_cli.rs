...
-> Result<(), Box<dyn std::error::Error>> {
    ...
    let output = Command::new(env!("CARGO_BIN_EXE_codewide-host-rs"))
        .arg("pair")
        .arg("--json")
...
-> Result<(), Box<dyn std::error::Error>> {
    ...
    let unicode = Command::new(env!("CARGO_BIN_EXE_codewide-host-rs"))
        .arg("pair")
        .arg("--qr")
        .arg("unicode")
        .arg("--control-endpoint")
    ...
    let svg = Command::new(env!("CARGO_BIN_EXE_codewide-host-rs"))
        .arg("pair")
        .arg("--qr")
        .arg("svg")
        .arg("--qr-output")
...
-> Result<(), Box<dyn std::error::Error>> {
    ...
    let first = Command::new(env!("CARGO_BIN_EXE_codewide-host-rs"))
        .arg("create-token")
        .arg("--token-file")
        .arg(&token_file)
        .output()
    ...
    let second = Command::new(env!("CARGO_BIN_EXE_codewide-host-rs"))
        .arg("create-token")
        .arg("--token-file")
        .arg(&token_file)
        .output()
