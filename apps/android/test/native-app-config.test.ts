...
describe("checked-in Android project mirrors app config", () => {
  ...
  it("keeps background connection and privacy-safe activity notifications wired", () => {
    ...
    expect(threadChatProjection).toContain("reconcileThreadLifecyclePresentation(projectedThread)");
    ...
    expect(remoteWorkspace).toContain("await readThread(connectionId, threadId, cachedThread, true)");
    ...
    expect(screen).toContain("const requiresJournalCatchUp = remoteThread === null");
