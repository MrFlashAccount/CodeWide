...
describe("document preview", () => {
  ...
  it("owns Markdown reading controls in the fullscreen viewer chrome", () => {
    ...
    expect(documentPreview).toContain("<DocumentTextScaleControl");
    expect(documentPreview).toContain('accessibilityLabel="Decrease document text size"');
    expect(documentPreview).toContain('accessibilityLabel="Reset document text size"');
    expect(documentPreview).toContain('accessibilityLabel="Increase document text size"');
    expect(documentPreview).not.toContain('{ id: "text-smaller"');
    expect(documentPreview).not.toContain('{ id: "text-larger"');
