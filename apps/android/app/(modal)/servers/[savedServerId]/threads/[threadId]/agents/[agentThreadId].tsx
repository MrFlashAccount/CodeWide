...
import { AgentThreadScreen } from "@/v2/features/agents/AgentThreadScreen";
import { qualifiedThreadRouteParams, threadRouteParam } from "@/v2/features/navigation/routeParams";
