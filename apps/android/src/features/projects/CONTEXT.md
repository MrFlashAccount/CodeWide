...
Public entrypoints are ProjectPickerFeature/ProjectPickerSheet and its input contract; projectSelection/projectWorkspace, activeProjectSelection, composerProjectSelection and newChat; NewThreadServerSheet/NewThreadFloatingButton; and SidebarProjects/sidebarProjects presentation contracts. Picker sessions, row projection, management state, leaf views and styles are private. Peer imports are limited to public connection display and navigation contracts.
