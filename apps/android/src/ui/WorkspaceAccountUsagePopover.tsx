...
import { threadListAccountUsageSources, type AccountUsageServer } from "../data/thread-list-account-usage";
import { UsagePopover } from "./UsagePopover";

/** Account updates repaint this menu without invalidating the sidebar or conversation. */
export function WorkspaceAccountUsagePopover({ database, servers, ...props }:
