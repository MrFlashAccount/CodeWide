...
export default function SearchCalendar(props: CalendarProps) {
  ...
  return <Host colorScheme="dark" pointerEvents="box-none"><DatePickerDialog initialDate={initialDate} variant="picker" showVariantToggle={false}
    color={colors.primary} confirmButtonLabel="Select" dismissButtonLabel="Cancel" onDateSelected={select} onDismissRequest={props.onDismiss} /></Host>;
}
