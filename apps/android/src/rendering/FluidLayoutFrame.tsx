...
interface FluidLayoutProps extends ViewProps { readonly animate: boolean }

const NativeFrame = Platform.OS === "android" && UIManager.getViewManagerConfig("CodeWideFluidLayout") != null
  ? requireNativeComponent<FluidLayoutProps>("CodeWideFluidLayout") : null;
...
export function FluidLayoutFrame({ animate, ...props }: FluidLayoutProps) {
  ...
  return NativeFrame === null ? <View {...props} />
